...
/**
 * Phase 1 wrapper: behavior is identical to the delegate logger.
 */
public final class SensitiveLogger implements Logger {

    private final Logger delegate;

    public SensitiveLogger(Logger delegate) {
